...
public class Collection implements org.apache.thrift.TBase<Collection, Collection._Fields>, java.io.Serializable, Cloneable, Comparable<Collection> {
  ...
  private static final org.apache.thrift.protocol.TField FAVOR_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("favorId", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  public String favorId; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FAVOR_ID, new org.apache.thrift.meta_data.FieldMetaData("favorId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Collection(Collection other) {
    if (other.isSetFavorId()) {
      this.favorId = other.favorId;
    }
  ...
  public Collection setFavorId(String favorId) {
    this.favorId = favorId;
    return this;
  }

  public void unsetFavorId() {
    this.favorId = null;
  }

  /** Returns true if field favorId is set (has been assigned a value) and false otherwise */
  public boolean isSetFavorId() {
    return this.favorId != null;
  }

  public void setFavorIdIsSet(boolean value) {
    if (!value) {
      this.favorId = null;
    }
  }
  ...
  public Collection setCompanyIdList(List<String> companyIdList) {
    this.companyIdList = companyIdList;
    return this;
  }
  ...
  public Collection setEmployIdList(List<String> employIdList) {
    this.employIdList = employIdList;
    return this;
  }
  ...
  public Collection setApplicationIdList(List<String> applicationIdList) {
    this.applicationIdList = applicationIdList;
    return this;
  }
  ...
  public Collection setTeachinIdList(List<String> teachinIdList) {
    this.teachinIdList = teachinIdList;
    return this;
  }
  ...
  public Collection setExaminationIdList(List<String> examinationIdList) {
    this.examinationIdList = examinationIdList;
    return this;
  }
  ...
  public Collection setInterviewIdList(List<String> interviewIdList) {
    this.interviewIdList = interviewIdList;
    return this;
  }
  ...
  public boolean equals(Collection that) {
    ...
    boolean this_present_favorId = true && this.isSetFavorId();
    boolean that_present_favorId = true && that.isSetFavorId();
    if (this_present_favorId || that_present_favorId) {
      if (!(this_present_favorId && that_present_favorId))
        return false;
      if (!this.favorId.equals(that.favorId))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_favorId = true && (isSetFavorId());
    list.add(present_favorId);
    if (present_favorId)
      list.add(favorId);
  ...
  public int compareTo(Collection other) {
    ...
    lastComparison = Boolean.valueOf(isSetFavorId()).compareTo(other.isSetFavorId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFavorId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.favorId, other.favorId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class CollectionStandardScheme extends StandardScheme<Collection> {
        ...
        switch (schemeField.id) {
          case 1: // FAVOR_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.favorId = iprot.readString();
              struct.setFavorIdIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Collection struct) throws org.apache.thrift.TException {
      ...
      if (struct.favorId != null) {
        oprot.writeFieldBegin(FAVOR_ID_FIELD_DESC);
        oprot.writeString(struct.favorId);
        oprot.writeFieldEnd();
      }
