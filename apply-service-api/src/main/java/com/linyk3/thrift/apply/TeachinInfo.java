...
public class TeachinInfo implements org.apache.thrift.TBase<TeachinInfo, TeachinInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TeachinInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TeachinInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new TeachinInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TeachinInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TeachinInfo.class, metaDataMap);
  }
   ...
   */
  public TeachinInfo(TeachinInfo other) {
  ...
  public TeachinInfo deepCopy() {
    return new TeachinInfo(this);
  }
  ...
  public TeachinInfo set_id(String _id) {
    this._id = _id;
    return this;
  }
  ...
  public TeachinInfo setCompanyId(String companyId) {
    this.companyId = companyId;
    return this;
  }
  ...
  public TeachinInfo setCompanyName(String companyName) {
    this.companyName = companyName;
    return this;
  }
  ...
  public TeachinInfo setSchool(String school) {
    this.school = school;
    return this;
  }
  ...
  public TeachinInfo setAddress(String address) {
    this.address = address;
    return this;
  }
  ...
  public TeachinInfo setDate(String date) {
    this.date = date;
    return this;
  }
  ...
  public TeachinInfo setStatus(int status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public TeachinInfo setMarks(String marks) {
    this.marks = marks;
    return this;
  }
  ...
  public TeachinInfo setPositions(String positions) {
    this.positions = positions;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TeachinInfo)
      return this.equals((TeachinInfo)that);
    return false;
  }

  public boolean equals(TeachinInfo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TeachinInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TeachinInfo(");
    boolean first = true;
  ...
  private static class TeachinInfoStandardSchemeFactory implements SchemeFactory {
    public TeachinInfoStandardScheme getScheme() {
      return new TeachinInfoStandardScheme();
    }
  }

  private static class TeachinInfoStandardScheme extends StandardScheme<TeachinInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TeachinInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TeachinInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TeachinInfoTupleSchemeFactory implements SchemeFactory {
    public TeachinInfoTupleScheme getScheme() {
      return new TeachinInfoTupleScheme();
    }
  }

  private static class TeachinInfoTupleScheme extends TupleScheme<TeachinInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TeachinInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TeachinInfo struct) throws org.apache.thrift.TException {
