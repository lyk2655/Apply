 ...
 *
 */
public class MajorDetailResult implements Serializable{

	private static final long serialVersionUID = -6657256422908955633L;
	...
	public int hashCode() {
		...
		result = prime * result + ((major_intro == null) ? 0 : major_intro.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MajorDetailResult other = (MajorDetailResult) obj;
		if (company_dis == null) {
		...
		if (major_id == null) {
			...
			return false;
		if (major_intro == null) {
			if (other.major_intro != null)
				return false;
		} else if (!major_intro.equals(other.major_intro))
			return false;
		if (major_name == null) {
	...
	public String toString() {
		return "MajorDetailResult [major_id=" + major_id + ", major_name=" + major_name + ", major_category="
				+ major_category + ", major_second_category=" + major_second_category + ", major_intro=" + major_intro
				+ ", sample_count=" + sample_count + ", industry_dis=" + industry_dis + ", industry_status="
				+ industry_status + ", top_worker_city=" + top_worker_city + ", top_worker_city_ratio="
				+ top_worker_city_ratio + ", gender_dis=" + gender_dis + ", gender_status=" + gender_status
				+ ", salary_factor=" + salary_factor + ", salary_factor_rank=" + salary_factor_rank + ", salary_stats="
				+ salary_stats + ", predict_salary_stats=" + predict_salary_stats + ", salary_predict_show_type="
				+ salary_predict_show_type + ", country_salary_stats=" + country_salary_stats
				+ ", in_country_salary_index=" + in_country_salary_index + ", location_dis=" + location_dis
				+ ", zhineng_dis=" + zhineng_dis + ", company_dis=" + company_dis + "]";
	}
